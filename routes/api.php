...
Route::prefix('workpoints-admin')->group(function () {
    Route::get('/', [WorkpointAdminController::class, 'index'])
        ->withoutMiddleware([PermV1::class, PermV2::class])
        ->name('workpoints.admin.index');

    Route::post('/', [WorkpointAdminController::class, 'store'])
        ->withoutMiddleware([PermV1::class, PermV2::class])
        ->name('workpoints.admin.store');

    Route::put('/{id}', [WorkpointAdminController::class, 'update'])
        ->whereNumber('id')
        ->withoutMiddleware([PermV1::class, PermV2::class])
        ->name('workpoints.admin.update');

    Route::delete('/{id}', [WorkpointAdminController::class, 'destroy'])
        ->whereNumber('id')
        ->withoutMiddleware([PermV1::class, PermV2::class])
        ->name('workpoints.admin.destroy');
});
...
})->where('path', '.*')->name('attendance.files');
