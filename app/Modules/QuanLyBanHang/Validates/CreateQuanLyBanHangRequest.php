  ...
  public function rules(): array
  {
    return [
      ...
      'danh_sach_san_pham.*.san_pham_label'  => ['sometimes', 'nullable', 'string', 'max:255'],
       // 🔹 HẠNG MỤC GỐC (Nhóm gói dịch vụ) – tên dùng cho cột HẠNG MỤC trên báo giá
